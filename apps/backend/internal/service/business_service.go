...
type BusinessService interface {
	...
	AddText(ctx context.Context, businessID uuid.UUID, title, content string) (int, error)
...
func (s *businessService) AddText(ctx context.Context, businessID uuid.UUID, title, content string) (int, error) {
